...
<div>
  ...
  <ol>
    <li>3 a:<br> Run using <code>python3 graph.py</code><br>
        <p align="center">
        <img src="graphpyImg.png" width="100%" height="100%">
       </p><br>
    </li>
    <li>3 b, 3c:<br> Run using <code>python3 main.py</code><br>
        <p align="center">
        <img src="main3bc.png" width="100%" height="100%">
       </p><br>
    </li>
    <li>3 d to 3i, except 3h:<br> Run using <code>python3 graphSearch.py</code><br>
        <p align="center">
        <img src="graphSearchpyImg.png" width="100%" height="100%">
       </p><br>
    </li>
    <li>3 h:<br> Uncomment the recursive call lines in 
        ...
        <p align="center">
        <img src="recursionError3h.png" width="100%" height="100%">
       </p><br>
    </li>
  </ol>
</div>
